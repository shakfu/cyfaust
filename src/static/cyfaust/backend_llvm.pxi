...
cdef class LlvmDsp:
    ...
    # Runtime parameters
    #
    # Mirrors InterpreterDsp's param API (see interp.pyx). Reuses the
    # module-level Param namedtuple, _PARAM_KINDS and _BARGRAPH_TYPES emitted
    # into cyfaust.pyx from the interpreter amalgamation.
    # -------------------------------------------------------------------------
