...
"""
interpretercpp C++ interface for compiling Faust code with the Interpreter backend.
...
"""
interpreter_dsp_factory* createInterpreterDSPFactoryFromFile(const string& filename,
...
@return a DSP factory on success, otherwise a null pointer.
""" 
interpreter_dsp_factory* createInterpreterDSPFactoryFromString(const string& name_app,
...
@return a DSP factory on success, otherwise a null pointer.
"""
interpreter_dsp_factory* createInterpreterDSPFactoryFromSignals(const string& name_app,
                                                                             tvec signals,
                                                                             int argc, const char* argv[],
                                                                             string& error_msg)
...
@return a DSP factory on success, otherwise a null pointer.
"""
interpreter_dsp_factory* createInterpreterDSPFactoryFromBoxes(const string& name_app,
                                                                           Box box,
                                                                           int argc, const char* argv[],
                                                                           string& error_msg)
...
"""
DEPRECATED(vector<string> getInterpreterDSPFactoryLibraryList(interpreter_dsp_factory* factory))
...
"""
bool writeInterpreterDSPFactoryToBitcodeFile(interpreter_dsp_factory* factory, const string& bit_code_path)
