...
class TestCInterfaceStructures:
    ...
    def test_dsp_function_pointers_concept(self):
        ...
        assert dsp1.get_numinputs() == dsp2.get_numinputs(), (
            "Both DSPs should have same input count"
        )
        assert dsp1.get_numoutputs() == dsp2.get_numoutputs(), (
            "Both DSPs should have same output count"
        )
